...
class ber(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._EbN0_range = Range(-200, 200, 1, 11, 200)
        self._EbN0_win = RangeWidget(self._EbN0_range, self.set_EbN0, "Energy Bit / Noise Power", "counter_slider", float, QtCore.Qt.Horizontal)
