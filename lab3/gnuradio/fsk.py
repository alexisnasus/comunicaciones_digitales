...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.space_freq = space_freq = 2000
        self.samp_rate = samp_rate = 48000
        self.my_delay = my_delay = 50
        self.mark_freq = mark_freq = 8000
        self.dev_freq = dev_freq = 10000
        ...
        self.blocks_threshold_ff_0 = blocks.threshold_ff(6, 2, 0)
        self.blocks_selector_0 = blocks.selector(gr.sizeof_float*1,1,0)
        self.blocks_selector_0.set_enabled(True)
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_char*1, 48)
        ...
        self.blocks_add_const_vxx_0 = blocks.add_const_ff(0.2)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 500, 1, 0, 0)
        self.analog_random_uniform_source_x_0 = analog.random_uniform_source_b(0, 2, 0)
        self.analog_quadrature_demod_cf_0 = analog.quadrature_demod_cf(6.11155)
        self.analog_frequency_modulator_fc_0 = analog.frequency_modulator_fc(1.309)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.blocks_selector_0, 2))
        ...
        self.connect((self.blocks_delay_0, 0), (self.blocks_null_sink_0, 1))
